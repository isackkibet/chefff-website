    ...
    <section className="pb-24 px-4 sm:px-6 lg:px-8" aria-label="FAQ accordion">
      <div className="mx-auto max-w-3xl">
          ...
          {faqItems.map((item, i) => (
            <div key={i}>
              <dt>
                ...
                >
                  <span className="font-medium text-[hsl(42_30%_94%)]">
                    {item.question}
                  </span>
                  <ChevronDown
                    size={18}
                    aria-hidden="true"
                    className={cn(
                      "shrink-0 text-[hsl(45_90%_52%)] transition-transform duration-200",
                      open === i && "rotate-180",
                    )}
                  />
                </button>
              ...
              >
                <p className="px-6 pb-5 text-sm text-[hsl(0_0%_60%)] leading-relaxed">
                  {item.answer}
                </p>
              </dd>
            </div>
        ...
        <div className="mt-12 rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(45_90%_52%/0.2)] p-8 text-center">
          ...
          <p className="text-sm text-[hsl(0_0%_55%)] mb-6">
