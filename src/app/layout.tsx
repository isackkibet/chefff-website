...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Exceptional food. Unforgettable experiences. Private chef, event catering and culinary experiences across Nairobi.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Chef Harrizona, Private Dining & Catering",
      },
    ],
  },
  twitter: {
