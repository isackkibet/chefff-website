...
export const metadata: Metadata = {
  ...
  description:
    "Browse Chef Harrizona's full menu of starters, mains, desserts, drinks and chef specials. Filter by dietary requirements.",
};
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-lg text-[hsl(0_0%_65%)] leading-relaxed max-w-xl mx-auto">
            Every dish is crafted from the finest seasonal ingredients. Menus
            for private events are fully customised, and this is Chef
            Harrizona's signature collection.
          </p>
        </div>
      </section>
      <MenuClient />
