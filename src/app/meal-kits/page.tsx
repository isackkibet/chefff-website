...
export default function MealKitsPage() {
  return (
    <>
      {/* Hero */}
      <section
        className="pt-24 pb-12 sm:pt-32 sm:pb-16 px-4 sm:px-6 lg:px-8"
        aria-label="Meal kits header"
      >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[hsl(0_0%_65%)] leading-relaxed mb-8">
                Bring Chef Harrizona's expertise to your kitchen with our
                carefully curated meal kits. Fresh ingredients, traditional
                recipes, and step-by-step guidance for authentic Kenyan cuisine.
              </p>
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Fresh ingredients guaranteed",
                  },
                ].map(({ icon, text }) => (
                  <span
                    key={text}
                  ...
                  >
                    <span className="text-[hsl(45_90%_52%)]" aria-hidden="true">
                      {icon}
                    </span>
                    {text}
                  </span>
              ...
              <div className="flex items-center gap-3">
                <div className="flex">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <svg
                      key={i}
                      className="size-5 fill-[hsl(45_90%_52%)] text-[hsl(45_90%_52%)]"
                      viewBox="0 0 20 20"
                      aria-hidden="true"
                    >
                ...
                <span className="text-sm text-[hsl(0_0%_50%)]">
                  from 1,143 reviews
                </span>
              </div>
            </div>
