...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (rest.ingredients !== undefined) updates.ingredients = JSON.stringify(rest.ingredients)
    if (rest.allergens   !== undefined) updates.allergens   = JSON.stringify(rest.allergens)
    if (rest.dietary     !== undefined) updates.dietary     = JSON.stringify(rest.dietary)
