...
export const metadata: Metadata = {
  title:
    "Chef Harrizona | Private Dining, Catering & Culinary Experiences in Nairobi",
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
          ...
          <p className="animate-fade-up delay-200 text-base sm:text-xl text-[hsl(42_30%_85%)] max-w-2xl mx-auto mb-6 sm:mb-10 leading-relaxed">
            𝑨 𝒔𝒌𝒊𝒍𝒍𝒆𝒅 𝒂𝒏𝒅 𝒅𝒆𝒕𝒆𝒓𝒎𝒊𝒏𝒆𝒅 𝒄𝒉𝒆𝒇 𝒅𝒆𝒅𝒊𝒄𝒂𝒕𝒆𝒅 𝒕𝒐 𝒇𝒖𝒍𝒇𝒊𝒍𝒍 𝒚𝒐𝒖𝒓 𝒄𝒖𝒍𝒊𝒏𝒂𝒓𝒚
            𝒘𝒊𝒔𝒉𝒆𝒔, 𝒘𝒉𝒆𝒕𝒉𝒆𝒓 𝒊𝒕𝒔 𝒂𝒏 𝒐𝒖𝒕𝒅𝒐𝒐𝒓 𝒆𝒗𝒆𝒏𝒕 𝒐𝒓 𝒂𝒕 𝒕𝒉𝒆 𝒄𝒐𝒎𝒇𝒐𝒓𝒕 𝒐𝒇 𝒚𝒐𝒖𝒓 𝒉𝒐𝒎𝒆.
          </p>
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    size={14}
                    className="fill-[hsl(45_90%_52%)] text-[hsl(45_90%_52%)]"
                    aria-hidden="true"
                  />
                ))}
              </div>
              <p className="text-sm text-[hsl(42_30%_80%)]">
                Trusted by 100+ guests
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ── Stats ────────────────────────────────────────────── */}
      <section
        className="bg-[hsl(0_0%_7%)] border-y border-[hsl(0_0%_16%)] py-12"
          ...
          <dl className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                <dt className="text-3xl sm:text-4xl font-display font-bold text-gold-gradient">
                  {s.value}
                </dt>
                <dd className="mt-1 text-sm text-[hsl(0_0%_55%)] uppercase tracking-wide">
                  {s.label}
                </dd>
              </div>
            ))}
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredServices.map((s) => (
              ...
              >
                <div className="mb-4 text-[hsl(45_90%_52%)]" aria-hidden="true">
                  <ServiceIcon name={s.icon} size={40} />
                </div>
            ...
            {featuredDishes.map((dish) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-[hsl(0_0%_55%)] leading-relaxed mb-3 line-clamp-2">
                    {dish.description}
                  </p>
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href="/menu"
                      className="text-xs font-medium text-[hsl(42_30%_94%)] hover:text-[hsl(45_90%_52%)] transition-colors"
                    >
                      View dish →
                    </Link>
                  </div>
      ...
      <section
        ...
        aria-label="About Chef Harrizona"
      >
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-[hsl(0_0%_65%)] leading-relaxed mb-6 text-lg">
              It is an experience, a memory and a way of bringing people
              together. Chef Harrizona has spent over a decade honing his craft
              across Nairobi's finest kitchens and private estates.
            </p>
            <p className="text-[hsl(0_0%_65%)] leading-relaxed mb-8">
              Specialising in contemporary African cuisine with classical French
              technique, every dish he carries his philosophy: exceptional
              ingredients, honest cooking and an unforgettable experience for
              every guest.
            </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredTestimonials.map((t) => (
              <blockquote
                key={t.id}
                className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6 card-hover"
              >
                <StarRating rating={t.rating} className="mb-4" />
                <p className="text-[hsl(42_30%_85%)] leading-relaxed mb-6 italic">
                  "{t.text}"
                </p>
                <footer className="flex items-center justify-between">
                  <div>
                    <cite className="not-italic font-semibold text-sm text-[hsl(42_30%_94%)]">
                      {t.name}
                    </cite>
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-[hsl(0_0%_65%)] text-lg mb-10 max-w-xl mx-auto">
            Whether it's an intimate dinner for two or a wedding for 200, get in
            touch and let Chef Harrizona bring the experience to you.
          </p>
