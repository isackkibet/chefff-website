...
export const metadata: Metadata = {
  ...
  description:
    "Read Chef Harrizona's blog for recipes, culinary tips, chef stories and guides to private dining and Kenyan cuisine.",
};
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-lg text-[hsl(0_0%_65%)] leading-relaxed">
            Tips, recipes, culinary stories and guides from the kitchen of Chef
            Harrizona.
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
                {rest.map((post) => (
                  <article
                    key={post.id}
                    className="group flex gap-5 rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-5 card-hover"
                  >
                    <Link
                      href={`/blog/${post.slug}`}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-[hsl(0_0%_50%)] line-clamp-2 mb-2">
                          {post.excerpt}
                        </p>
