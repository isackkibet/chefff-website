...
export const metadata: Metadata = {
  ...
  description: 'Browse Chef Harrizona\'s gallery — food photography, private dining events, weddings, corporate catering and behind-the-scenes moments.',
}

export default function GalleryPage() {
  return (
    <>
      <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8 text-center" aria-label="Gallery header">
