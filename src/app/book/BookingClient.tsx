...
const steps = [
  {
    ...
    desc: "Share the basics: date, location, guest count and type.",
  },
  {
    icon: <Users size={20} />,
    title: "Design Your Menu",
    desc: "Chef Harrizona creates a personalised proposal for you.",
  },
  {
    icon: <CheckCircle size={20} />,
    title: "Confirm",
    desc: "Review and approve the proposal and deposit terms.",
  },
  {
    icon: <MapPin size={20} />,
    title: "Enjoy",
    desc: "Chef arrives, cooks and serves an unforgettable experience.",
  },
];

const inputClass =
  "w-full rounded-xl bg-[hsl(0_0%_10%)] border border-[hsl(0_0%_22%)] px-4 py-3 text-sm text-[hsl(42_30%_94%)] placeholder:text-[hsl(0_0%_40%)] focus:outline-none focus:border-[hsl(45_90%_52%)] transition-colors";
      ...
      >
        <div className="mx-auto max-w-lg text-center py-16">
          <div className="inline-flex size-20 items-center justify-center rounded-full bg-[hsl(142_71%_45%/0.15)] mb-6">
            <CheckCircle
              size={40}
              className="text-[hsl(142_71%_45%)]"
              aria-hidden="true"
            />
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-3">
            Asante{guestName ? `, ${guestName}` : ""}! Request Received
          </h2>
          <p className="text-[hsl(0_0%_55%)] mb-8">
            Your booking request is safely with Chef Harrizona. He will
            personally review the details and get back to you within 24 hours.
            Karibu sana!
          </p>
          ...
          <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6 mb-8 text-left">
            ...
            <p className="font-display text-2xl font-bold text-[hsl(45_90%_52%)] mb-4">
              #{bookingId}
            </p>
            ...
            <ol className="space-y-3" aria-label="Booking status">
              {[
                ...
                <li key={label} className="flex items-center gap-3">
                  ...
                  >
                    {done && (
                      <CheckCircle size={12} className="text-[hsl(0_0%_10%)]" />
                    )}
                  </span>
                  <span
                    className={`text-sm ${done ? "text-[hsl(42_30%_94%)] font-medium" : "text-[hsl(0_0%_40%)]"}`}
                  >
                    {label}
                  </span>
                  {done && (
                    <span className="ml-auto text-xs px-2 py-0.5 rounded-full bg-[hsl(45_90%_52%/0.15)] text-[hsl(45_90%_52%)]">
                      Current
                    </span>
                  )}
                </li>
          ...
          <p className="text-sm text-[hsl(0_0%_45%)]">
            Confirmation details will be sent to your email. For urgent
          ...
          <button
            ...
            className="mt-8 text-sm text-[hsl(45_90%_52%)] hover:underline"
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className={inputClass}
                      placeholder="Full address or area (e.g. Karen, Nairobi)"
                    />
                    {errors.location && (
                      <p role="alert" className={errorClass}>
              ...
              <fieldset className="mb-8">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label htmlFor="cuisinePrefs" className={labelClass}>
                      Cuisine Preferences
                    </label>
                    <input
                      id="cuisinePrefs"
                      ...
                      className={inputClass}
                      placeholder="e.g. East African, Italian, Mixed"
                    />
                  </div>
                  <div>
                    <label htmlFor="dietaryReqs" className={labelClass}>
              ...
              <p className="mt-4 text-xs text-[hsl(0_0%_40%)] text-center">
                Submitting this form does not confirm a booking. Chef Harrizona
                will review your request and contact you within 24 hours. A
                deposit is required to confirm. See{" "}
                <a
        ...
        <div className="space-y-6">
            ...
            <ol className="space-y-5" role="list">
              {steps.map((step, i) => (
                <li key={step.title} className="flex gap-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[hsl(42_30%_94%)]">
                      {step.title}
                    </p>
          ...
          <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6 space-y-4">
            ...
            {[
              ...
              <div
                key={text}
                className="flex items-center gap-3 text-sm text-[hsl(0_0%_60%)]"
              >
                <Icon
                  size={15}
