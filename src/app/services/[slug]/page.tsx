      ...
      <article className="pb-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            {s.price && s.originalPrice && (
              <div className="mb-8 rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(45_90%_52%/0.3)] p-5">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    {s.priceLabel && (
                      <p className="text-xs text-[hsl(0_0%_45%)] mb-0.5">
                        {s.priceLabel}
                      </p>
                    )}
                  ...
                  <div className="rounded-xl bg-[hsl(0_0%_9%)] border border-[hsl(0_0%_16%)] overflow-hidden">
                    <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[hsl(0_0%_14%)]">
                      <Tag
                        ...
                        aria-hidden="true"
                      />
                      <span className="text-xs font-semibold uppercase tracking-wide text-[hsl(0_0%_45%)]">
                        Item Pricing
                      </span>
                    </div>
                    <dl className="divide-y divide-[hsl(0_0%_13%)]">
                      {s.pricingItems.map(({ item, price, unit }) => (
                        ...
                        >
                          <dt className="text-sm text-[hsl(42_30%_85%)] font-medium">
                            {item}
                          </dt>
                          <dd className="text-right">
                            {price > 0 ? (
                              <>
                                ...
                                <span className="text-xs text-[hsl(0_0%_45%)] ml-1.5">
                                  {unit}
                                </span>
                              </>
                            ) : (
                              <span className="text-xs italic text-[hsl(45_90%_52%)]">
                                {unit}
                              </span>
                            )}
                          </dd>
            ...
            <p className="text-[hsl(0_0%_65%)] leading-relaxed text-lg mb-8">
              {s.description}
            </p>
            ...
            <ul className="space-y-3 mb-10" role="list">
              {s.features.map((f) => (
                <li
                  key={f}
                  className="flex items-center gap-3 text-[hsl(0_0%_65%)]"
                >
                  <CheckCircle
                    size={18}
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {others.map((sv) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="mb-3 text-[hsl(45_90%_52%)]"
                      aria-hidden="true"
                    >
                      <ServiceIcon name={sv.icon} size={28} />
                    </div>
                    <h3 className="font-semibold mb-1 group-hover:text-[hsl(45_90%_52%)] transition-colors">
                      {sv.title}
                    </h3>
                    <p className="text-sm text-[hsl(0_0%_55%)] mb-3">
                      {sv.short}
                    </p>
                    {other.price && (
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-bold text-[hsl(45_90%_52%)]">
                          KES {other.price.toLocaleString()}
                        </span>
                        {other.originalPrice && (
                          <span className="text-xs text-[hsl(0_0%_40%)] line-through">
                            KES {other.originalPrice.toLocaleString()}
                          </span>
                        )}
                      </div>
                    )}
