...
export default function MealKitsSection() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[hsl(0_0%_8%)]" aria-label="Authentic Kenyan meal kits">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-4">
                  ...
                  <h2 className="mt-2 font-display font-semibold text-base leading-snug mb-1">{kit.name}</h2>
                  <p className="text-xs text-[hsl(0_0%_55%)] leading-relaxed mb-3 line-clamp-2 flex-1">{kit.shortDesc}</p>

                  <div className="flex items-center gap-3 mb-3 text-xs text-[hsl(0_0%_50%)]">
                    <span className="flex items-center gap-1"><Users size={12} aria-hidden="true" /> {kit.serves}</span>
                    <span className="flex items-center gap-1"><Clock size={12} aria-hidden="true" /> {kit.time}</span>
