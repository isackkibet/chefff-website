...
const process = [
  {
    ...
    desc: "Share your date, location, guest count, event type and any food preferences.",
  },
  {
    step: "02",
    title: "Design Your Menu",
    desc: "Chef Harrizona creates a personalised menu proposal for your approval.",
  },
  {
    step: "03",
    title: "Confirm & Deposit",
    desc: "Review the proposal, confirm the details and secure with a deposit.",
  },
  {
    step: "04",
    title: "Enjoy",
    desc: "Chef Harrizona arrives, sets up and delivers an unforgettable culinary experience.",
  },
];
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-lg text-[hsl(0_0%_65%)] leading-relaxed">
            Every service is designed around your specific needs. No templates.
            No compromise.
          </p>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Priced service packages"
      >
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <span
                      className="absolute top-4 left-4 text-[hsl(45_90%_52%)]"
                      aria-hidden="true"
                    >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <p className="text-[hsl(0_0%_60%)] text-sm leading-relaxed mb-5">
                      {s.description}
                    </p>
                    ...
                    {s.pricingItems && s.pricingItems.length > 0 && (
                      <div className="mb-5 rounded-2xl bg-[hsl(0_0%_9%)] border border-[hsl(0_0%_18%)] overflow-hidden">
                        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[hsl(0_0%_16%)]">
                          <Tag
                            size={14}
                            className="text-[hsl(45_90%_52%)]"
                            aria-hidden="true"
                          />
                          <span className="text-xs font-semibold uppercase tracking-wide text-[hsl(0_0%_50%)]">
                            Pricing
                          </span>
                        </div>
                        <dl className="divide-y divide-[hsl(0_0%_14%)]">
                          {s.pricingItems.map(({ item, price, unit }) => (
                            ...
                            >
                              <dt className="text-sm text-[hsl(42_30%_85%)]">
                                {item}
                              </dt>
                              <dd className="text-right">
                                {price > 0 ? (
                                  ...
                                  <span className="text-xs text-[hsl(45_90%_52%)] italic">
                                    {unit}
                                  </span>
                                )}
                              </dd>
                    ...
                    <ul className="space-y-2 mb-6 flex-1" role="list">
                      {s.features.slice(0, 4).map((f) => (
                        <li
                          key={f}
                          className="flex items-start gap-2.5 text-sm text-[hsl(0_0%_60%)]"
                        >
                          <CheckCircle
                            size={15}
      ...
      <section className="pb-24 px-4 sm:px-6 lg:px-8" aria-label="All services">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow="Full Services"
            title="All Culinary Services"
            centered={false}
          />
          <div className="space-y-8">
            {standardServices.map((service, idx) => (
              ...
              >
                <div>
                  <div
                    className="mb-4 text-[hsl(45_90%_52%)]"
                    aria-hidden="true"
                  >
                    <ServiceIcon name={service.icon} size={48} />
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-bold mb-4">
                    {service.title}
                  </h2>
                  <p className="text-[hsl(0_0%_65%)] leading-relaxed mb-6">
                    {service.description}
                  </p>
                  <ul className="space-y-2.5 mb-8" role="list">
                    {service.features.map((f) => (
                      <li
                        key={f}
                        className="flex items-center gap-2.5 text-sm text-[hsl(0_0%_65%)]"
                      >
                        <CheckCircle
                          size={16}
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow="The Process"
            title="How It Works"
            subtitle="Four simple steps from enquiry to unforgettable experience."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map(({ step, title, desc }) => (
              <div
                key={step}
                className="relative rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6 card-hover"
              >
                <span
                  className="text-5xl font-display font-bold text-[hsl(45_90%_52%/0.18)] absolute top-4 right-5"
                  aria-hidden="true"
                >
                  {step}
                </span>
                <h3 className="font-semibold text-base mb-2 relative">
                  {title}
                </h3>
                <p className="text-sm text-[hsl(0_0%_55%)] leading-relaxed relative">
                  {desc}
                </p>
              </div>
            ))}
      ...
      >
        <div className="mx-auto max-w-2xl">
          ...
          <p className="text-[hsl(0_0%_65%)] mb-10">
            Send your enquiry and Chef Harrizona will get back to you within 24
