...
export const metadata: Metadata = {
  ...
  description:
    "Real testimonials from Chef Harrizona's guests: private dining, wedding catering, corporate events and cooking classes.",
};
...
export default async function ReviewsPage() {
  ...
  const avgRating =
    displayReviews.reduce((sum, t) => sum + t.rating, 0) /
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-[hsl(0_0%_55%)]">
              Based on {displayReviews.length} verified review
      ...
      <section
        className="bg-[hsl(0_0%_7%)] border-y border-[hsl(0_0%_16%)] py-10 px-4 sm:px-6 lg:px-8"
          ...
          <dl className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                <dt className="text-3xl font-display font-bold text-gold-gradient">
                  {s.value}
                </dt>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            subtitle="These are real reviews from real guests. We never fabricate feedback."
          />
            ...
            {displayReviews.map((t) => (
              <blockquote
                ...
                className={`rounded-2xl border p-6 card-hover flex flex-col ${
                  t.featured
                    ? "bg-[hsl(0_0%_14%)] border-[hsl(45_90%_52%/0.3)]"
              ...
              >
                ...
                <p className="text-[hsl(42_30%_85%)] leading-relaxed italic flex-1 mb-6">
                  “{t.text}”
                </p>
                <footer className="flex items-center justify-between mt-auto pt-4 border-t border-[hsl(0_0%_18%)]">
                  ...
                  <span className="text-xs px-2.5 py-1 rounded-full bg-[hsl(0_0%_18%)] text-[hsl(0_0%_55%)]">
                    {t.service}
                  </span>
                </footer>
              </blockquote>
      ...
      <section
        className="pb-24 px-4 sm:px-6 lg:px-8 text-center"
        aria-label="Book call to action"
      >
        <div className="mx-auto max-w-2xl">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6">
            Ready to Create Your Own{" "}
            <span className="text-gold-gradient">Memory?</span>
          </h2>
