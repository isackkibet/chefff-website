    ...
    >
      <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-16">
        ...
        <div>
                ...
                {href ? (
                  <a href={href} className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-[hsl(42_30%_94%)] group-hover:text-[hsl(45_90%_52%)] transition-colors">
                        {value}
                      </p>
                    </div>
                  </a>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-[hsl(42_30%_94%)]">
                        {value}
                      </p>
                    </div>
                  </div>
          ...
          {/* Socials */}
          <div>
            <p className="text-sm font-semibold uppercase tracking-wider text-[hsl(0_0%_45%)] mb-3">
              Follow the Journey
            </p>
          ...
          <div className="mt-10 rounded-2xl overflow-hidden h-56 bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] flex items-center justify-center">
            <div className="text-center">
              <MapPin
                size={32}
                className="text-[hsl(45_90%_52%)] mx-auto mb-2"
                aria-hidden="true"
              />
          ...
          <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6 sm:p-8">
            ...
            {submitted ? (
              <div className="py-12 text-center animate-fade-in">
                <CheckCircle
                  size={48}
                  className="text-[hsl(142_71%_45%)] mx-auto mb-4"
                  aria-hidden="true"
                />
                <h3 className="text-xl font-semibold mb-2">
                  Asante{submittedName ? `, ${submittedName}` : ""}! Message
                  Received
                </h3>
                <p className="text-[hsl(0_0%_55%)] max-w-sm mx-auto">
                  Chef Harrizona has received your message and will reply to you
                  personally within 24 hours. Karibu sana!
                </p>
                <button
                  onClick={() => setSubmitted(false)}
                  className="mt-6 text-sm text-[hsl(45_90%_52%)] hover:underline"
                >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Subject{" "}
                    <span aria-hidden="true" className="text-[hsl(0_72%_65%)]">
                      *
                    </span>
                  </label>
                  <input
                ...
                <p className="text-xs text-[hsl(0_0%_40%)] text-center">
                  Your information is only used to respond to your enquiry. See
                  our{" "}
                  <a
                    href="/privacy-policy"
