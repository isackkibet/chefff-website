...
export const metadata: Metadata = {
  ...
  description:
    "Contact Chef Harrizona for enquiries about private dining, catering, cooking classes and events in Nairobi.",
};
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-lg text-[hsl(0_0%_65%)] leading-relaxed">
            Have a question, an upcoming event or simply want to learn more?
            Send a message and Chef Harrizona will respond within 24 hours.
          </p>
        </div>
      </section>
      <ContactClient />
