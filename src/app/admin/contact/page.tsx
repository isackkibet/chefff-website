        ...
        <main className="flex-1 pt-14 lg:pt-0 overflow-x-hidden">
          <div className="p-6 lg:p-8 max-w-7xl mx-auto">
            ...
            <div className="relative flex-1 max-w-sm mb-6">
              <Search
                size={16}
                className="absolute left-3 top-1/2 -translate-y-1/2 text-[hsl(0_0%_40%)]"
                aria-hidden="true"
              />
              <input
                type="search"
            ...
            <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] overflow-hidden">
              {loading ? (
                ...
                <p className="px-6 py-14 text-center text-sm text-[hsl(0_0%_45%)]">
                  No messages yet. When someone uses the Get in Touch form,
                ...
                <ul className="divide-y divide-[hsl(0_0%_14%)]" role="list">
                  {filtered.map((m) => (
                    <li key={m.id}>
                      ...
                      >
                        <span
                          className={`mt-0.5 size-9 shrink-0 flex items-center justify-center rounded-xl ${!m.read ? "bg-[hsl(45_90%_52%/0.15)] text-[hsl(45_90%_52%)]" : "bg-[hsl(0_0%_16%)] text-[hsl(0_0%_45%)]"}`}
                        >
                          {m.read ? (
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                            ...
                            {!m.read && (
                              <span className="rounded-full bg-[hsl(45_90%_52%)] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-[hsl(0_0%_10%)]">
                                New
                              </span>
                            )}
                          ...
                          <p className="text-sm text-[hsl(0_0%_65%)] mt-0.5">
                            {m.subject}
                          </p>
                          <p className="text-sm text-[hsl(0_0%_50%)] truncate mt-0.5">
                            {m.message}
                          </p>
                        </div>
                        <span
                          className="mt-1 size-8 shrink-0 flex items-center justify-center rounded-lg bg-[hsl(0_0%_16%)] text-[hsl(0_0%_50%)]"
                          aria-hidden="true"
                        >
                          <Eye size={14} />
                        </span>
          ...
          <div>
            <div className="flex items-start justify-between gap-4 mb-5 pr-8">
              <div>
                <p className="text-xs text-[hsl(0_0%_45%)] uppercase tracking-wide mb-1">
                  {new Date(selected.createdAt).toLocaleDateString("en-KE", {
                    weekday: "long",
                    day: "numeric",
                    month: "long",
                    year: "numeric",
              ...
              {!selected.read && (
                <span className="rounded-full bg-[hsl(45_90%_52%)] px-3 py-1 text-xs font-bold uppercase tracking-wide text-[hsl(0_0%_10%)]">
                  New
                </span>
              )}
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3 mb-6 text-sm">
              {[
                ...
                <div key={label}>
                  <p className="text-xs text-[hsl(0_0%_45%)] uppercase tracking-wide mb-0.5">
                    {label}
                  </p>
            ...
            <div className="mb-6 rounded-xl bg-[hsl(0_0%_10%)] border border-[hsl(0_0%_18%)] p-4">
              <p className="text-xs text-[hsl(0_0%_45%)] uppercase tracking-wide mb-2">
                Message
              </p>
              <p className="text-sm text-[hsl(42_30%_85%)] whitespace-pre-wrap leading-relaxed">
                {selected.message}
              </p>
            </div>
