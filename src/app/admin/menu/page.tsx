...
export default function AdminMenuPage() {
  ...
  const filtered =
    filterCat === "All" ? items : items.filter((m) => m.category === filterCat);
  ...
  return (
    <AdminGuard>
              ...
              {filtered.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-[hsl(0_0%_55%)] line-clamp-2 mb-3">
                      {item.description}
                    </p>
                    <p className="font-bold text-[hsl(45_90%_52%)] mb-3">
      ...
      <Modal
        open={modalMode !== null}
        onClose={closeModal}
        aria-label={modalMode === "add" ? "Add dish" : "Edit dish"}
        className="max-w-lg"
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={inputClass}
              placeholder="Salmon, Lemon, Capers…"
            />
          </div>
          <div>
            <label
              htmlFor="dish-allergens"
              className="block text-sm font-medium mb-1.5"
            >
