  ...
  async function setApproved(id: string, approved: boolean) {
    try {
      ...
      toast(
        "success",
        approved
          ? "Review approved, now live on the site"
          : "Review unapproved, hidden from the site",
      );
    } catch {
          ...
          <div className="p-6 lg:p-8 max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-sm text-[hsl(0_0%_50%)]">
                {items.length} submitted · {pending.length} awaiting approval ·{" "}
                {approved.length} live on the site
              </p>
            </div>
            ...
            <div className="rounded-xl bg-[hsl(45_90%_52%/0.06)] border border-[hsl(45_90%_52%/0.2)] px-4 py-3 mb-8">
              <p className="text-xs text-[hsl(45_90%_52%)]">
                <strong>How it works:</strong> Reviews submitted by guests land
                here as <em>pending</em>. Approve them to publish on the Reviews
                page, or delete anything inappropriate.
              </p>
            </div>
            ...
            {loading ? (
              ...
              <>
                {[
                  ...
                  {
                    title: `Approved and Live (${approved.length})`,
                    data: approved,
                  },
                ].map(
                  ({ title, data }) =>
                          ...
                          {data.map((r) => (
                            ...
                            >
                              <div className="flex items-center justify-between gap-2 mb-3">
                                ...
                                <Badge variant={r.approved ? "gold" : "muted"}>
                                  {r.approved ? "Live" : "Pending"}
                                </Badge>
                              </div>
                              <p className="text-sm text-[hsl(42_30%_85%)] italic leading-relaxed mb-4 line-clamp-4">
                                "{r.review}"
                              </p>
                              <p className="text-sm font-semibold text-[hsl(42_30%_94%)]">
                                {r.name}
                              </p>
                              <p className="text-xs text-[hsl(0_0%_45%)] mb-1">
                ...
                {items.length === 0 && (
                  <div className="py-24 text-center">
                    ...
                    <p className="text-[hsl(0_0%_40%)]">
                      No reviews submitted yet. When guests review your service,
