...
export default function AdminSettingsPage() {
  ...
  const [seoForm, setSeoForm] = useState({
    ...
    metaDescription:
      "Chef Harrizona offers private dining, bespoke event catering, cooking classes and weekly meal preparation across Nairobi and surrounding areas.",
  ...
  const Section = ({
    ...
    <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6 mb-6">
      <h2 className="text-lg font-semibold mb-6 pb-3 border-b border-[hsl(0_0%_16%)]">
        {title}
      </h2>
          ...
          <div className="p-6 lg:p-8 max-w-3xl mx-auto">
            ...
            >
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="s-whatsapp" className={labelClass}>
                    WhatsApp Number
                  </label>
                  <input
                    id="s-whatsapp"
                    ...
                    className={inputClass}
                    placeholder="254768737930"
                  />
                </div>
                <div>
                  <label htmlFor="s-hours" className={labelClass}>
                    Business Hours
                  </label>
                  <input
                    id="s-hours"
            ...
            <Section title="Booking & Payments" onSave={() => save("Booking")}>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="s-dep" className={labelClass}>
                    Deposit Required (%)
                  </label>
                  <input
                    id="s-dep"
                    ...
                    min="0"
                    max="100"
                    value={bookingForm.depositPercent}
                    onChange={(e) =>
                      setBookingForm({
                        ...bookingForm,
                ...
                <div>
                  <label htmlFor="s-notice" className={labelClass}>
                    Minimum Notice (days)
                  </label>
                  <input
                    id="s-notice"
                ...
                <div>
                  <label htmlFor="s-currency" className={labelClass}>
                    Currency
                  </label>
                  <input
                    id="s-currency"
                ...
                <div>
                  <label htmlFor="s-maxguests" className={labelClass}>
                    Max Guests Per Event
                  </label>
                  <input
                    id="s-maxguests"
                    type="number"
                    value={bookingForm.maxGuests}
                    onChange={(e) =>
                      setBookingForm({
                        ...bookingForm,
            ...
            <Section title="SEO & Metadata" onSave={() => save("SEO")}>
              <div>
                <label htmlFor="s-meta-title" className={labelClass}>
                  Default Page Title
                </label>
                <input
                  id="s-meta-title"
              ...
              <div>
                <label htmlFor="s-meta-desc" className={labelClass}>
              ...
              <div>
                <label htmlFor="s-canonical" className={labelClass}>
                  Canonical URL
                </label>
                <input
                  id="s-canonical"
            ...
            <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-6">
              <div className="flex items-start gap-3">
                <Shield
                  size={20}
                  className="text-[hsl(45_90%_52%)] shrink-0 mt-0.5"
                  aria-hidden="true"
                />
                <div>
                  ...
                  <ul className="text-sm text-[hsl(0_0%_55%)] space-y-1.5">
                    ...
                    <li>
                      • Store all secrets in environment variables, never in
                      code
                    </li>
                    <li>• Enable HTTPS on your production domain</li>
                    <li>
                      • The current auth uses localStorage (demo only), replace
                      with secure HTTP-only sessions in production
                    </li>
