        ...
        <div className="rounded-2xl bg-[hsl(0_0%_12%)] border border-[hsl(0_0%_18%)] p-8">
          {locked ? (
            <div className="text-center py-4">
              <AlertCircle size={40} className="text-[hsl(0_72%_65%)] mx-auto mb-3" aria-hidden="true" />
              <p className="font-semibold text-[hsl(0_72%_65%)]">Account temporarily locked</p>
              <p className="text-sm text-[hsl(0_0%_50%)] mt-2">Too many failed attempts. Please try again later or contact support.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
              {authError && (
                <div role="alert" className="flex items-center gap-2 rounded-xl bg-[hsl(0_72%_51%/0.1)] border border-[hsl(0_72%_51%/0.3)] px-4 py-3 text-sm text-[hsl(0_72%_70%)]">
                  <AlertCircle size={16} aria-hidden="true" /> {authError}
                </div>
              )}

              <div>
                <label htmlFor="admin-email" className="block text-sm font-medium mb-1.5">Email Address</label>
                <input
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    {...register('password')} aria-required="true" aria-invalid={!!errors.password}
                ...
                {errors.password && <p role="alert" className="mt-1 text-xs text-[hsl(0_72%_65%)]">{errors.password.message}</p>}
              </div>
