                ...
                <ul className="divide-y divide-[hsl(0_0%_14%)]" role="list">
                  {items.map((item) => (
                    <li key={item.ref}>
                      ...
                      >
                        <span
                          className={`mt-0.5 size-8 shrink-0 flex items-center justify-center rounded-lg ${item.kind === "booking" ? "bg-[hsl(45_90%_52%/0.15)] text-[hsl(45_90%_52%)]" : "bg-[hsl(210_80%_56%/0.15)] text-[hsl(210_80%_70%)]"}`}
                        >
                          {item.kind === "booking" ? (
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-[hsl(0_0%_55%)] truncate">
                            {item.sub}
                          </p>
                        </div>
                      </Link>
