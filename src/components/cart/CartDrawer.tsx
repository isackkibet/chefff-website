...
export default function CartDrawer() {
  ...
  const GITHUB_BASE =
    "https://raw.githubusercontent.com/isackkibet/chefff-website/main/public";
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 px-6 text-center">
            ...
            <p className="text-sm text-[hsl(0_0%_50%)]">
              Add meal kits, dishes or services and place your order on
              WhatsApp.
            </p>
            <button
              onClick={closeCart}
          ...
          <>
            ...
            >
              {items.map((item) => (
                <li
                  key={item.id}
                  className="flex gap-3 rounded-xl bg-[hsl(0_0%_13%)] border border-[hsl(0_0%_18%)] p-3"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[hsl(42_30%_94%)] leading-snug">
                      {item.name}
                    </p>
