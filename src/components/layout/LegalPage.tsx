  ...
  return (
    <>
      <div className="pt-28 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-6">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-[hsl(0_0%_55%)] hover:text-[hsl(45_90%_52%)] transition-colors">
      ...
      <article className="pb-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <header className="mb-10">
            ...
            <p className="text-sm text-[hsl(0_0%_45%)]">Last updated: {lastUpdated}</p>
