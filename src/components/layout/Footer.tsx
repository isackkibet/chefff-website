    ...
    <footer className="bg-[hsl(0_0%_7%)] border-t border-[hsl(0_0%_16%)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Quick links */}
          <div>
            <h3 className="font-semibold text-[hsl(42_30%_94%)] mb-4 text-sm uppercase tracking-wider">
              Quick Links
            </h3>
            <ul className="space-y-2.5" role="list">
              {quickLinks.map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-sm text-[hsl(0_0%_55%)] hover:text-[hsl(45_90%_52%)] transition-colors"
                  >
                    {l.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3" role="list">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-sm text-[hsl(0_0%_55%)] hover:text-[hsl(45_90%_52%)] transition-colors"
                >
                  <Phone
                    size={15}
          ...
          >
            {legalLinks.map((l) => (
              <li key={l.href}>
                <Link
                  href={l.href}
                  className="text-xs text-[hsl(0_0%_40%)] hover:text-[hsl(45_90%_52%)] transition-colors"
                >
                  {l.label}
                </Link>
              </li>
