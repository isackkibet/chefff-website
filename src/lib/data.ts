...
export const brand = {
  ...
  whatsappMsg:
    "Hello Chef Harrizona, I would like to enquire about a private dining experience.",
};
...
export const services = [
  {
    ...
    title: "Private Chef",
    short:
      "A personalised restaurant experience in your home or chosen location.",
    description:
  ...
  },
  {
    ...
    features: [
      ...
      "Working lunch boxes",
      "Canapes & cocktail receptions",
      "Full corporate dinners",
    ],
  ...
  },
  {
    ...
    short:
      "Customised menus and full service for birthdays, anniversaries and celebrations.",
    description:
  ...
  },
  {
    ...
    short:
      "Healthy, restaurant-quality meals prepared weekly for busy lifestyles.",
    description:
  ...
  },
  {
    ...
    short:
      "Handcrafted samosas, spring rolls, pizza and more, all made fresh to order.",
    description:
  ...
  },
  {
    ...
    short:
      "Full breakfast, lunch buffets and dinner, professionally prepared at your location.",
    description:
...
export const menuItems: MenuItem[] = [
  // ── Chef Specials, Authentic Kenyan (NEW · shown first) ─────────────────
  {
    ...
    description:
      "Chef Harrizona's slow-charred goat, kachumbari, ugali crisps and house pepper sauce.",
    price: 3200,
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Fresh tilapia in rich coconut curry with aromatic coastal spices, served with basmati rice.",
    price: 2800,
    image:
      "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80",
    ingredients: [
      "Fresh tilapia/kingfish",
      "Fresh coconut milk",
      "Coastal spice mix",
      "Curry leaves",
      "Coriander",
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Fragrant Kenyan pilau with Harrizona's secret masala blend, premium basmati and tender beef.",
    price: 3500,
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Hearty mixed beans and maize, perfectly seasoned with traditional spices and fresh vegetables.",
    price: 1800,
    image:
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Farm-fresh sukuma wiki elevated with special seasoning, served with premium ugali.",
    price: 1200,
    image:
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Authentic Kikuyu mukimo made with mashed potato, pumpkin leaves, green maize and traditional beans.",
    price: 2400,
    image:
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Fluffy layered chapatis with slow-cooked rich beef stew, the ultimate Kenyan comfort meal.",
    price: 3800,
    image: "/chapati.jpeg",
    ingredients: [
      "Premium wheat flour",
  ...
  },
  {
    ...
    category: "Chef Specials",
    description:
      "Golden mandazi, premium chai and fresh accompaniments for the classic Kenyan morning experience.",
    price: 1600,
    image:
...
export const galleryImages: GalleryImage[] = [
  {
    ...
    alt: "Traditional nyama choma platter",
    caption: "Nyama Choma Platter",
    category: "Food",
  },
  {
    id: "g2",
    src: "/pilau-masala.jpeg",
    alt: "Fragrant pilau masala with spices",
    caption: "Pilau Masala",
    category: "Food",
  },
  {
    id: "g3",
    src: "/chapati.jpeg",
    alt: "Chapati and beef stew",
    caption: "Chapati & Beef Stew",
    category: "Food",
  },
  {
    id: "g4",
    src: "/private-chef.jpeg",
    alt: "Chef Harrizona ready for a private event",
    caption: "Private Chef",
    category: "Private Dining",
  },
  {
    id: "g5",
    src: "/chef-about.jpeg",
    alt: "Chef Harrizona in the kitchen",
    caption: "Chef Harrizona",
    category: "Chef",
  },
  {
    id: "g6",
    src: "/chef-about-2.jpeg",
    alt: "Chef Harrizona in chef whites",
    caption: "Chef Harrizona",
    category: "Chef",
  },
  {
    ...
    alt: "Signature dish from Chef Harrizona",
    caption: "Signature Dish",
    category: "Food",
  },
  {
    id: "g8",
    src: "/gallery-food-2.jpeg",
    alt: "Signature dish from Chef Harrizona",
    caption: "Signature Dish",
    category: "Food",
  },
  ...
  },
  {
    ...
    caption: "Corporate Buffet",
    category: "Events",
  },
  {
    id: "g14",
    src: "/private-events.jpeg",
    alt: "Outdoor private dinner party setting",
    caption: "Outdoor Dinner",
    category: "Events",
  },
  {
    id: "g15",
    src: "/meal-preparation.jpeg",
    alt: "Weekly meal prep bowls and trays",
    caption: "Meal Prep",
    category: "Food",
  },
  {
    id: "g16",
    src: "/cooking-classes.jpeg",
    alt: "Cooking masterclass in progress",
...
export const events: ChefEvent[] = [
  {
    ...
    description:
      "An intimate 12-seat dining experience built around a seasonal menu sourced entirely from local Kenyan farms.",
    type: "upcoming",
    category: "Private Dining",
    image:
      "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80",
  ...
  },
  {
    ...
    description:
      "A deep dive into classic Kenyan flavours: nyama choma, elevated sukuma wiki and modern takes on traditional desserts.",
    type: "upcoming",
  ...
  },
  {
    ...
    description:
      "A five-course tasting menu with paired mocktails and views over Nairobi at sunset.",
    type: "upcoming",
  ...
  },
  {
    ...
    description:
      "Full-day wedding catering for 200 guests with a custom six-course menu.",
    type: "past",
  ...
  },
  {
    ...
    description:
      "Gala dinner for 80 executives at an annual technology conference.",
    type: "past",
...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "Yes. Chef Harrizona provides full in-home dining experiences, bringing the restaurant to your table complete with preparation, service and kitchen clean-up.",
  },
  {
    question: "How far in advance should I book?",
    answer:
      "We recommend booking at least 2 weeks in advance for private dining and small events. For weddings and large events, 2–3 months notice ensures the best availability and preparation.",
  },
  {
    question: "Can you accommodate dietary requirements?",
    answer:
      "Absolutely. Chef Harrizona accommodates vegetarian, vegan, gluten-free, dairy-free and most allergy-specific requirements. Please detail your needs when booking so we can design your menu accordingly.",
  },
  {
    question: "Do you provide catering equipment and staff?",
    answer:
      "Yes. We can supply all necessary cooking and serving equipment. For larger events we also provide trained serving staff. This is confirmed and priced during your consultation.",
  },
  {
    question: "Is a deposit required to secure a booking?",
    answer:
      "Yes. A 40% deposit is required to confirm your booking. The remaining balance is due 48 hours before your event. Full payment terms are included in your booking confirmation.",
  },
  {
    question: "Can menus be fully customised?",
    answer:
      "Yes. Every menu is designed around you: your preferences, dietary needs, cuisine style and the occasion. A consultation call or tasting session is included for events of 10 or more guests.",
  },
  {
    question: "Do you travel outside Nairobi?",
    answer:
      "Chef Harrizona primarily serves Nairobi and surrounding areas. Travel to other counties is possible and subject to a travel fee. Contact us with your event location for a specific quote.",
  },
  {
    question: "What is your cancellation policy?",
    answer:
      "Cancellations made more than 7 days before the event receive a full deposit refund. Cancellations within 7 days forfeit the deposit. Full details are provided in the booking agreement.",
  },
];
...
export const mealKits: MealKit[] = [
  {
    ...
    description:
      "Everything you need for an authentic Kenyan barbecue experience. Premium goat meat with traditional spices and sides.",
    shortDesc:
      "Authentic Kenyan BBQ with premium goat, traditional spices, ugali and kachumbari.",
    image: "/nyama-choma.jpeg",
    serves: "4–6 people",
    time: "45 minutes",
    difficulty: "Easy",
    ...
    features: [
      ...
      "Harrizona Cullinaries' signature spices",
    ],
    ingredients: [
      "2kg premium goat meat",
      "Traditional spice blend",
  ...
  },
  {
    ...
    description:
      "Bring the flavors of the Kenyan coast to your home. Fresh fish with coconut curry and aromatic coastal spices.",
    shortDesc:
      "Fresh tilapia or kingfish in rich coconut curry with authentic coastal spices and basmati.",
    image:
  ...
  },
  {
    ...
    description:
      "Master the art of Kenyan pilau with our complete kit. Aromatic spices and premium ingredients for the perfect pilau.",
    shortDesc:
      "Fragrant Kenyan pilau with Harrizona's secret masala blend, premium rice and tender meat.",
    image: "/pilau-masala.jpeg",
    serves: "6–8 people",
    time: "60 minutes",
  ...
  },
  {
    ...
    slug: "githeri-kit",
    description:
      "Nutritious and delicious vegetarian Kenyan meal. Perfectly seasoned beans and maize with fresh vegetables.",
    shortDesc:
      "Hearty Kenyan githeri with premium mixed beans, maize and a nourishing traditional seasoning.",
    image:
  ...
  },
  {
    ...
    description:
      "Elevate everyday sukuma wiki into a gourmet experience. Fresh greens with special seasoning and accompaniments.",
    shortDesc:
      "Farm-fresh sukuma wiki elevated with Harrizona's special seasoning and premium accompaniments.",
    image:
  ...
  },
  {
    ...
    slug: "mukimo-kit",
    description:
      "Authentic Kikuyu mukimo with all traditional ingredients. Perfect comfort food with a modern twist.",
    shortDesc:
      "Classic Kikuyu mukimo with mashed potato, pumpkin leaves, green maize and traditional beans.",
    image:
  ...
  },
  {
    ...
    description:
      "Perfect combination of soft chapatis and rich beef stew. A complete meal that brings families together.",
    shortDesc:
      "Fluffy layered chapatis with rich slow-cooked beef stew, the ultimate Kenyan comfort meal.",
    image: "/chapati.jpeg",
    serves: "4–6 people",
    time: "75 minutes",
    difficulty: "Intermediate",
  ...
  },
  {
    ...
    description:
      "Start your day the Kenyan way. Traditional breakfast items including mandazi, chai, and accompaniments.",
    shortDesc:
      "Golden mandazi, premium chai and classic Kenyan breakfast accompaniments. Morning sorted.",
    image:
