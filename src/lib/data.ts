...
export const services = [
  ...
  },
  {
    ...
    short: 'Handcrafted samosas, spring rolls, pizza and more, all made fresh to order.',
    description:
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    category: 'Chef Specials',
    description: 'Authentic Kikuyu mukimo made with mashed potato, pumpkin leaves, green maize and traditional beans.',
    price: 2400,
  ...
  },
  {
    ...
    category: 'Chef Specials',
    description: 'Golden mandazi, premium chai and fresh accompaniments for the classic Kenyan morning experience.',
    price: 1600,
...
export const events: ChefEvent[] = [
  ...
  },
  {
    ...
    description: 'A deep dive into classic Kenyan flavours: nyama choma, elevated sukuma wiki and modern takes on traditional desserts.',
    type: 'upcoming',
...
export const mealKits: MealKit[] = [
  ...
  },
  {
    ...
    shortDesc: 'Classic Kikuyu mukimo with mashed potato, pumpkin leaves, green maize and traditional beans.',
