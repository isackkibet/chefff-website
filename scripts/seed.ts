...
async function seed() {
  ...
  // ── Menu items ──────────────────────────────────────────────────────────────
  const menuRows = [
    { name: 'Seared Scallops',               category: 'Starters',     price: 1800, chef_pick: true,  available: true,
      ...
      allergens: '["Shellfish","Dairy"]', dietary: '[]' },
    { name: 'Roasted Beetroot Salad',        category: 'Starters',     price: 1200, chef_pick: false, available: true,
      ...
      allergens: '["Dairy","Tree Nuts"]', dietary: '["Vegetarian","Gluten Free","Contains Nuts"]' },
    { name: 'Butternut Soup',                category: 'Starters',     price: 950,  chef_pick: false, available: true,
      ...
      allergens: '[]', dietary: '["Vegan","Gluten Free","Dairy Free"]' },
    { name: 'Signature Grilled Beef Tenderloin', category: 'Mains',   price: 4500, chef_pick: true,  available: true,
    ...
    { name: 'Pan-Seared Salmon',             category: 'Mains',        price: 3800, chef_pick: false, available: true,
      ...
      allergens: '["Fish","Dairy"]', dietary: '["Gluten Free"]' },
    { name: 'Lamb Rack',                     category: 'Mains',        price: 5200, chef_pick: true,  available: true,
      ...
      allergens: '["Dairy","Gluten"]', dietary: '[]' },
    { name: 'Wild Mushroom Risotto',         category: 'Mains',        price: 2800, chef_pick: false, available: true,
      ...
      allergens: '["Dairy","Sulphites"]', dietary: '["Vegetarian","Gluten Free"]' },
    { name: 'Chocolate Fondant',             category: 'Desserts',     price: 1400, chef_pick: true,  available: true,
      ...
      allergens: '["Dairy","Eggs","Gluten"]', dietary: '[]' },
    { name: 'Mango Panna Cotta',             category: 'Desserts',     price: 1100, chef_pick: false, available: true,
      ...
      allergens: '[]', dietary: '["Dairy Free","Gluten Free"]' },
    { name: 'Hibiscus Iced Tea',             category: 'Drinks',       price: 450,  chef_pick: false, available: true,
      ...
      allergens: '[]', dietary: '["Vegan","Gluten Free","Dairy Free"]' },
    { name: 'Spiced Lamb Samosas',           category: 'Chef Specials', price: 1600, chef_pick: true, available: true,
      description: 'Crispy pastry filled with spiced minced lamb, peas and fresh coriander. Served with tamarind chutney.',
  ...
  // ── Blog posts ──────────────────────────────────────────────────────────────
  const blogRows = [
    { slug: '5-secrets-to-perfect-grilled-beef', title: '5 Secrets to Perfect Grilled Beef',
    ...
    { slug: 'the-art-of-the-tasting-menu', title: 'The Art of the Tasting Menu',
      ...
      category: 'Recipes', published_at: '2026-06-18', read_time: 8, featured: false },
  ]
